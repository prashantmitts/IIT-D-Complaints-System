 ...
 */
public class FragInstituteComplaints extends Fragment {
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.frag_institute_complaints,container,false);
        ...
        final RecyclerView rvComplaint = (RecyclerView)view.findViewById(R.id.viewInstituteComplaints);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            if (response1.getInt("success") == 1) {
                                ...
                                InstituteComplaintsAdapter adapter = new InstituteComplaintsAdapter(comp,getContext());
    ...
    class InstituteComplaintsAdapter extends RecyclerView.Adapter<ViewHolderIndi>
    {
        private ArrayList<recycler_complaints> complaintsArray;
        private LayoutInflater inflater;

        public InstituteComplaintsAdapter(ArrayList<recycler_complaints> allcomplaints, Context context)
        {
