 ...
 */
public class FragHostelComplaints extends Fragment {
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.frag_hostel_complaints,container,false);
        ...
        final RecyclerView rvComplaint = (RecyclerView)view.findViewById(R.id.viewHostelComplaints);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            if (response1.getInt("success") == 1) {
                                ...
                                HostelComplaintsAdapter adapter = new HostelComplaintsAdapter(comp,getContext());
    ...
    class HostelComplaintsAdapter extends RecyclerView.Adapter<ViewHolderIndi>
    {
        private ArrayList<recycler_complaints> complaintsArray;
        private LayoutInflater inflater;

        public HostelComplaintsAdapter(ArrayList<recycler_complaints> allcomplaints, Context context)
        {
